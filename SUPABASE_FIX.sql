-- ============================================================
--  DRAPE E-Commerce — Supabase Database Fix Script
...
alter table orders add column if not exists order_source text default 'web_checkout';
...
-- ============================================================
--  STEP 3: Drop old broken policies and recreate correctly
-- ============================================================
...
-- Orders: FIXED — allow guest inserts (user_id can be null)
...
-- Wishlists: only logged-in users manage their own
...
-- ============================================================
--  STEP 4: Insert sample products (only if table is empty)
-- ============================================================
...
begin
  if not exists (select 1 from products limit 1) then
    ...
    raise notice 'Products table already has data — skipping sample insert.';
  end if;
end $$;
